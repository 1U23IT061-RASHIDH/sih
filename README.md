...
## Admin Access and Contact Notifications
...
Only users with the `ADMIN` database role can open `/admin` or `/admin/analytics`. Messages submitted through the Contact Us form are delivered to the admin notification panel.

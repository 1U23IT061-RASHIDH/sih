        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Vehicle No */}
                    <div>
                        <label className="block text-sm font-bold text-slate-800 mb-2">Vehicle Number</label>
                        <input
                            type="text"
                            required
                            placeholder="TN 43 AZ 1234"
                            className="w-full p-3 border-2 border-slate-300 bg-white text-slate-900 rounded-lg focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none uppercase placeholder:text-slate-400"
                    ...
                    {/* Spot Selection */}
                    <div>
                        <label className="block text-sm font-bold text-slate-800 mb-2">Parking Location</label>
                        <select
                ...
                <div className="grid grid-cols-2 gap-4">
                    {/* Name */}
                    <div>
                        <label className="block text-sm font-bold text-slate-800 mb-2">Driver Name</label>
                        <input
                            type="text"
                            required
                            className="w-full p-3 border-2 border-slate-300 bg-white text-slate-900 rounded-lg outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
                    ...
                    {/* Members */}
                    <div>
                        <label className="block text-sm font-bold text-slate-800 mb-2">Members</label>
                        <input
                            type="number"
                            min="1"
                            className="w-full p-3 border-2 border-slate-300 bg-white text-slate-900 rounded-lg outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
                ...
                <div className="grid grid-cols-2 gap-4">
                    {/* Vehicle Type */}
                    <div>
                        <label className="block text-sm font-bold text-slate-800 mb-2">Vehicle Type</label>
                            ...
                            {['CAR', 'BUS', 'BIKE'].map(type => (
                                <button
                                    ...
                                    onClick={() => setForm({ ...form, vehicleType: type })}
                                        className={`flex-1 py-3 text-xs font-bold rounded-lg border-2 transition ${form.vehicleType === type
                    ...
                    {/* Category */}
                    <div>
                        <label className="block text-sm font-bold text-slate-800 mb-2">Ticket Class</label>
                        <select
                            className="w-full p-3 border-2 border-slate-300 bg-white text-slate-900 rounded-lg outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200"
                            value={form.type}

...
export default function BigIconMode({
    ...
    const popularDestinations = [
        ...
        { id: 'rose-garden', name: 'Roses', ta: 'ரோஜா', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Government_Rose_Garden%2C_Ooty%2C_Tamil_Nadu%2C_India.jpg/960px-Government_Rose_Garden%2C_Ooty%2C_Tamil_Nadu%2C_India.jpg' }
    ];

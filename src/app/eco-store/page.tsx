...
const DEMO_PRODUCTS: Product[] = [
    { id: 'demo-chocolates', name: 'Ooty Homemade Chocolates', description: 'Rich handmade chocolate assortment from the Nilgiris.', pricePoints: 50, priceCash: 250, category: 'Chocolates', imageUrls: ['https://images.unsplash.com/photo-1549007994-cb92caebd54b?auto=format&fit=crop&q=85&w=900'] },
    { id: 'demo-tea', name: 'Nilgiri Green Tea', description: 'Fresh, fragrant tea leaves from high-altitude estates.', pricePoints: 30, priceCash: 180, category: 'Tea', imageUrls: ['https://images.unsplash.com/photo-1597318181409-cf64d0b5d8a2?auto=format&fit=crop&q=85&w=900'] },
    { id: 'demo-spices', name: 'Nilgiri Spice Collection', description: 'Cardamom, cloves and cinnamon gathered from local growers.', pricePoints: 60, priceCash: 450, category: 'Spices', imageUrls: ['https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&q=85&w=900'] },
    { id: 'demo-handicrafts', name: 'Toda Handcrafted Shawl', description: 'A vibrant, traditional embroidered keepsake.', pricePoints: 200, priceCash: 1500, category: 'Handicrafts', imageUrls: ['https://images.unsplash.com/photo-1601924994987-69e26d50dc26?auto=format&fit=crop&q=85&w=900'] },
    { id: 'demo-toys', name: 'Nilgiri Wooden Toy Set', description: 'Hand-painted wooden toys made by local hill artisans.', pricePoints: 90, priceCash: 650, category: 'Toys', imageUrls: ['https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?auto=format&fit=crop&q=85&w=900'] },
];
        ...
        <div className="min-h-screen bg-slate-50 pb-20">
            ...
            <div className="max-w-6xl mx-auto px-6 -mt-8">
                ...
                <div className="flex gap-4 mb-8 overflow-x-auto pb-2 scrollbar-hide">
                    {['All', 'Chocolates', 'Tea', 'Spices', 'Handicrafts', 'Toys', 'Oil', 'Local Snacks', 'Health', 'Preserves'].map(cat => (
                        <button key={cat} onClick={() => setCategory(cat)} className={`px-6 py-3 whitespace-nowrap border rounded-2xl text-sm font-bold transition-all ${category === cat ? 'bg-emerald-600 text-white border-emerald-600' : 'bg-white border-slate-200 text-slate-600 hover:border-emerald-500 hover:text-emerald-600'}`}>
                            {cat}
                        </button>
                    ))}
                </div>

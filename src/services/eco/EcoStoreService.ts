...
export class EcoStoreService {
    ...
    static async seedProducts() {
        const products = [
            ...
            {
                name: "Nilgiri Wooden Toy Set",
                description: "Hand-painted wooden toys made by local hill artisans.",
                pricePoints: 90,
                priceCash: 650,
                category: "Toys",
                stock: 45,
                imageUrls: ["https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?auto=format&fit=crop&q=85&w=900"]
            },
            {
